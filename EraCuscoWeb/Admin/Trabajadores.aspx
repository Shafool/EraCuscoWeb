<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Trabajadores.aspx.cs" Inherits="EraCuscoWeb.Admin.Trabajadores" %>
...
<asp:Content ID="Descripcion" ContentPlaceHolderID="Descripcion" runat="server">
    Aquí podrás gestionar los usuarios que pueden hacer cambios en el sistema
</asp:Content>
    ...
    <div class="d-flex flex-wrap justify-content-center">
        ...
        <div class="d-flex flex-wrap justify-content-center">
            <div class="card p-3 my-5 carta">
                <table id="tbTrabajadores" class="table">
                    <thead>
                        <tr>
                            <th>Código</th>
                            <th>Trabajador</th>
        ...
        <!-- El Modal -->
        <div class="modal" id="modalAgregarTrabajador">
        <form>
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                    ...
                    <asp:Button type="button" class="btn btn-success" ID="btAgregarTrabajador" runat="server" Text="Agregar Trabajador" />
              </div>
            </div>
          </div>
        </form>
